    ...
    employeeList() {
        return this.state.employee.map(currentemployee => {
            return <Employee
                ...
                gotoUpdateEmployee={this.gotoUpdateEmployee}
            ...
            if (
                ...
                return (
                    <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600'>
                        ...
                        <td className='px-6 py-4'>{currentemployee.fullName}</td>
                        ...
                        <td className='flex justify-center px-6 py-4 '>
                            {
                                <div class="">
                                    <button className='inline-flex items-center px-4 py-2 mr-1 text-sm font-medium text-white bg-indigo-500 rounded-md hover:bg-blue-200' onClick={() => { this.gotoUpdateEmployee(currentemployee._id) }}>
